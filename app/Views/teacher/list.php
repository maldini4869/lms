...
<div class="container-fluid">
    ...
    <div class="row mb-3">
        <div class="col-md-6">
            <h1 class="h3 mb-2 text-gray-800">List Guru</h1>
        </div>
        <div class="col-md-6">
            <a class="btn btn-primary float-right" href="/guru/tambah" role="button">Tambah</a>
        </div>
    </div>
                    ...
                    <tbody>
                        <?php foreach ($teachers as $i => $teacher) : ?>
                            <tr>
                                ...
                                <td><?= $teacher['email']; ?></td>
                                <td>
                                    <a href="/guru/ubah/<?= $teacher['id']; ?>" style="text-decoration: none; color: inherit;">
                                        <i class="fas fa-edit mr-2" style="color: #FFD43B;"></i>
                                    </a>

                                    <form class="d-inline" action="/guru/<?= $teacher['id']; ?>" method="post">
                                        <?= csrf_field(); ?>
